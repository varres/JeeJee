...
privileged aspect PiiririkkujaController_Roo_Controller {
    ...
    void PiiririkkujaController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("piiririkkuja_suletud_date_format", "dd.MM.yyyy");
        uiModel.addAttribute("piiririkkuja_avatud_date_format", "dd.MM.yyyy");
        uiModel.addAttribute("piiririkkuja_muudetud_date_format", "dd.MM.yyyy");
