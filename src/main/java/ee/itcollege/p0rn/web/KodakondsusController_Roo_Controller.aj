...
privileged aspect KodakondsusController_Roo_Controller {
    ...
    void KodakondsusController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("kodakondsus_suletud_date_format", "dd.MM.yyyy");
        uiModel.addAttribute("kodakondsus_avatud_date_format", "dd.MM.yyyy");
        uiModel.addAttribute("kodakondsus_muudetud_date_format", "dd.MM.yyyy");
